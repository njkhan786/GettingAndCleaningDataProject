...
features <- read.table(unz(temporarylink,"UCI HAR Dataset/features.txt"),header=FALSE,sep=" ",stringsAsFactors=FALSE)
subjtest <- read.table(unz(temporarylink,"UCI HAR Dataset/test/subject_test.txt"),header=FALSE,sep=" ",stringsAsFactors=FALSE)
xtest <- read.table(unz(temporarylink,"UCI HAR Dataset/test/X_test.txt"),header=FALSE,stringsAsFactors=FALSE)
ytest <- read.table(unz(temporarylink,"UCI HAR Dataset/test/y_test.txt"),header=FALSE,stringsAsFactors=FALSE)
subjtrain <- read.table(unz(temporarylink,"UCI HAR Dataset/train/subject_train.txt"),header=FALSE,sep=" ",stringsAsFactors=FALSE)
xtrain <- read.table(unz(temporarylink,"UCI HAR Dataset/train/X_train.txt"),header=FALSE,stringsAsFactors=FALSE)
ytrain <- read.table(unz(temporarylink,"UCI HAR Dataset/train/y_train.txt"),header=FALSE,stringsAsFactors=FALSE)
activitytable <- read.table(unz(temporarylink,"UCI HAR Dataset/activity_labels.txt"),header=FALSE,sep=" ",stringsAsFactors=FALSE)
